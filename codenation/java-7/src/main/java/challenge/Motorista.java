...
public class Motorista {
    ...
    public final int maxPontos = 20;
    public final int minIdade = 18;
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        ...
        if (pontos > 20) {
            throw new EstacionamentoException("Excedeu o maximo de pontos");
        }
        if (nome == null) {
            throw new NullPointerException("Campo em branco");
        }
        if (habilitacao==null || habilitacao.trim().isEmpty()) {
            throw new NullPointerException("Campo em branco");
        }
        if(idade < 18 ){
            throw new EstacionamentoException("Di Menor");
        }            
